...
openssl x509 -in cloned_root_ca_comodo.crt -noout -text

echo "[INFO] Converting certificate to PKCS12..."
# The following will convert the certiciate into a PKCS12 file for use in Burp.
openssl pkcs12 -export -passout pass:password -inkey cloned_root_ca_comodo.key -in cloned_root_ca_comodo.crt -out cloned_root_ca_comodo_combo.p12

echo ""
echo "[INFO] Successfully cloned certificates into 'cloned_root_ca_comodo_combo.p12'"

# COMODO Reference Certificate
# -----BEGIN CERTIFICATE-----
